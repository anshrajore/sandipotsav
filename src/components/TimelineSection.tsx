...
const dayOverview = [
  ...
  },
  {
    ...
    events: ["Guess The Imposter" ,"Mehndi Competition", "Painting Competition"],
    icon: Palette,
    color: "bg-secondary",
  },
  {
    ...
    events: ["Meme Competition", "Shayari Competition", "Rangoli Competition", "Reel Competition", "Antakshari  (Only for Faculty)"],
    icon: Video,
    color: "bg-accent",
  },
  {
  ...
  },
  {
    ...
    date: "07-02-2026",
    theme: "Cultural Night",
    events: ["Sandip Foundation's Group of Institutes – Cultural Night"],
    venue: "SITRC Amphitheatre",
    icon: PartyPopper,
    color: "bg-accent",
  },
...
const detailedSchedule = [
  {
    day: "Day 1",
    date: "2 Feb, 2026 (Day 1)",
    dayName: "Monday",
    venue: "SUN S Building, Near Clock Tower (Stage)",
    slots: [
      { time: "11:00 AM - 12:30 PM", event: "Inauguration of SANDIPOTSAV- 2026" },
      { time: "01:00 PM - 02:30 PM", event: "Dance + Singing" },
  ...
  {
    day: "Day 2",
    date: "3 Feb, 2026 (Day 2)",
    dayName: "Tuesday",
    venue: "SUN S Building, Near Clock Tower (Stage)",
    slots: [
      { time: "10:30 AM - 11:00 AM", event: "Intro of Day & Start of Day" },
      { time: "11:00 AM - 12:00 PM", event: "Dance + Singing" },
      { time: "12:00 PM - 02:00 PM", event: "SUN Shining Stars, Mr. & Miss SUN (Round 1)" },
  ...
  {
    day: "Day 3",
    date: "4 Feb, 2026 (Day 3)",
    dayName: "Wednesday",
    venue: "SUN S Building, Near Clock Tower (Stage)",
    slots: [
      { time: "10:30 AM - 11:00 AM", event: "Intro of Day & Start of Day" },
      { time: "11:00 AM - 12:00 PM", event: "Dance + Singing" },
      { time: "12:00 PM - 02:00 PM", event: "SUN Shining Stars, Mr. & Miss SUN (Round 2)" },
      { time: "02:00 PM - 03:00 PM", event: "Ramp Walk" },
      { time: "03:00 PM - 04:30 PM", event: "Best Outfit + Games" },
    ],
  },
  {
    day: "Day 4",
    date: "5 Feb, 2026 (Day 4)",
    dayName: "Thursday",
    venue: "SUN S Building, Near Clock Tower (Stage)",
    slots: [
      { time: "10:30 AM - 11:00 AM", event: "Intro of Day & Start of Day" },
      { time: "11:00 AM - 12:00 PM", event: "Dance + Singing" },
      { time: "12:00 PM - 02:00 PM", event: "SUN Shining Stars, Mr. & Miss SUN ( Final Round )" },
      { time: "02:00 PM - 03:00 PM", event: "Ramp Walk (Faculty + Coordinator)" },
